    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
            <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
                ...
                <p className='text-gray-400 text-center'>Come join a large community of story tellers</p>
                <form className="space-y-4">
                    <div>
                        ...
                        <Input
                            ...
                            autoComplete="email"
                            required
                            className="w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
                        />
                    </div>
                    <div>
                    ...
                    <div className="text-center">
                        <p className="text-sm text-gray-600">
                            ...
                            <a href="/login" className="font-medium text-green-600 hover:text-green-500">x
                                Login
                            </a>
                        </p>
                    </div>
